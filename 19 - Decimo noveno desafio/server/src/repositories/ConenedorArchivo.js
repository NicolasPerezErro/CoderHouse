...
import { asDtoProd } from '../dto/productosDto.js'
import { asDtoMess } from '../dto/mensajesDto.js'
...
class ContenedorArchivo {
    ...
    async listar(id) {
        try {
            ...
            if (contenido.length > 0) {
                ...
                if (idEncontrado) {
                    //  DTO
                    // return asDtoProd(this.vecObj[pos])
                    // return asDtoMess(this.vecObj[pos])
    ...
    async listarAll() {
        try {
            ...
            //  DTO
            // return asDtoProd(this.vecObj)
            // return asDtoMess(this.vecObj)
            return this.vecObj;
        } catch (error) {
            logger.error(`${error}`)
            throw new Error('Error de lectura');
